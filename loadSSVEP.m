    ...
    for trial=1:15
        for flash=1:15
            ...
            for channel=channelRange
                ...
                [eegimg, DOTS, zerolevel] = eegimage(channel,signal,imagescale,timescale,false,minimagesize);
...
%%
channel=3;
figure;DisplayDescriptorImageFull(F,1,70,1,channel,100,false);
figure;DisplayDescriptorImageFull(F,1,145,2,channel,100,false);
figure;DisplayDescriptorImageFull(F,1,220,3,channel,100,false);